...
//
//--------------------------------------------------------------------------------
// RC2014 SCM changelog
//
// 2024-03-22 xsi inaciose, modified to run as SCM app
//
//--------------------------------------------------------------------------------
...
int loop(void)
{
  ...
  // memory free
  printf("TinyBasicPlus  RC2014\n\r");
  printf("---\n\r");
  printf("Original authors: Mike Field <hamster@snap.net.nz>\n\r");
  printf("                  Scott Lawrence <yorgle@gmail.com>\n\r");
  printf("     RC2014 port: Filippo Bergamasco <fbergama@gmail.com>\n\r");
  printf("     SCM app mod: xsi\n\r\n\r");
